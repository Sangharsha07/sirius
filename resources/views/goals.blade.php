...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: Arial, Helvetica, sans-serif; }
        ...
        .list-item { padding: 1.25rem; background: #f9fafb; border-radius: 12px; border-left: 4px solid #f59e0b; margin-bottom: 15px; display: flex; justify-content: space-between; align-items: center; }
        .status-pill { font-size: 13px; font-weight: bold; padding: 5px 12px; border-radius: 999px; }
    ...
    <div class="section-box">
        ...
        <div style="display: flex; flex-direction: column;">
            <div class="list-item" style="border-left-color: #f59e0b;">
                <div>
                    <strong style="font-size: 18px;">Sleep before 12 AM</strong>
                    <p style="font-size: 13px; color: #6b7280; margin-top: 3px;">Category: Sleep</p>
                </div>
            ...
            <div class="list-item" style="border-left-color: #10b981;">
                <div>
                    <strong style="font-size: 18px; text-decoration: line-through; opacity: 0.6;">Drink 2 liters of water</strong>
                    <p style="font-size: 13px; color: #6b7280; margin-top: 3px;">Category: Exercise</p>
                </div>
            ...
            <div class="list-item" style="border-left-color: #f59e0b;">
                <div>
                    <strong style="font-size: 18px;">Take study breaks</strong>
                    <p style="font-size: 13px; color: #6b7280; margin-top: 3px;">Category: Study Balance</p>
                </div>
                <span class="status-pill status-progress">⏳ In Progress</span>
            </div>
        </div>
